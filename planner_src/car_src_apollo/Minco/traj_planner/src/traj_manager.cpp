...
void TrajPlanner::displayMincoTraj(std::shared_ptr<plan_utils::SingulTrajData> display_traj)
{
    ...
    for (unsigned int i = 0; i < display_traj->size(); ++i)
    {
        ...
        //std::cout << "222222222222minco_duration: " << total_duration << std::endl;
        for (double t = 0; t <= total_duration; t += 0.01)
        {
            Eigen::Vector2d pt = display_traj->at(i).traj.getPos(t);
            //std::cout << "222222222222pt: " << pt << std::endl;
...
//   std::cout << "1iniState_container: " << iniState_container << std::endl;
//   std::cout << "2finState_container: " << finState_container << std::endl;
//   std::cout << "3waypoints_container: " << waypoints_container << std::endl;
//   std::cout << "4duration_container: " << duration_container << std::endl;
//   std::cout << "5sfc_container: " << sfc_container << std::endl;
//   std::cout << "6singul_container: " << singul_container << std::endl;
//   std::cout << "7worldtime: " << worldtime << std::endl;
  ...
  //std::cout << "flag_success: " << flag_success << std::endl;
