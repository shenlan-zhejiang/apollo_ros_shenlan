...
# print("mass="+str(vehicle_physics.mass)+"kg")
# print("center_of_mass:")
# print(vehicle_physics.center_of_mass)
# print("bbox_x="+str(vehicle.bounding_box.extent.x*2)+"m")
# print("longitudinal_stiffness="+str(vehicle_physics.wheels[0].long_stiff_value)+"kg/rad")
# print("max normalized tire load="+str(vehicle_physics.wheels[0].lat_stiff_max_load))
# print("max stiffness per unit of lateral slip="+str(vehicle_physics.wheels[0].lat_stiff_value))
