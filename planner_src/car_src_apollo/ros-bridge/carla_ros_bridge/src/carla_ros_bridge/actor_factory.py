...
from carla_ros_bridge.ackermann_control import AckermannControl
...
class ActorFactory(object):
        ...
        with self.spawn_lock:
            while not self._task_queue.empty():
                ...
                if task_type == ActorFactory.TaskType.SPAWN_ACTOR and not self.node.shutdown.is_set():
                    ...
                    self._create_object(actor_id, req.type, req.id, req.attach_to, req.transform, None, req.attributes)
    ...
    def _create_object(self, uid, type_id, name, attach_to, spawn_pose, carla_actor=None, attributes=None):
        ...
        elif type_id == AckermannControl.get_blueprint_name():
            actor = AckermannControl(uid=uid,
                                     name=name,
                                     parent=parent, 
                                     node=self.node,
