...
// bool notequal(double x, double y, double th)
// {
//   return (x - y) * (x - y) > th;
// }
...
{
    // std::cout << "********OdometryAndPointcloud_cb***********" << std::endl;

    // if (odom_msg->header.seq != 1725 || pcl_msg->header.seq != 58) {return;}
    // if (odom_msg->header.seq != 2083 || pcl_msg->header.seq != 91) {return;}
    if (__count_simon__ == 0 && (odom_msg->header.seq != 2083 || pcl_msg->header.seq != 91)) {
        return;
    }
    if (__count_simon__ == 10) {exit(0);}
    __count_simon__++;
    

    std::cout << "__count_simon__:" << __count_simon__ << std::endl;

    //std::cout << "odom pose:" << std::endl << odom_msg->pose.pose << std::endl;
    std::cout << "odom_msg seq: " << odom_msg->header.seq  << " timestamp sec: " << odom_msg->header.stamp<< std::endl;
    std::cout << "pcl_msg seq: " << pcl_msg->header.seq << " timestamp sec: " << pcl_msg->header.stamp << std::endl;
    ...
    for(int i=0; i<number_of_points_; i++)
    {
        ...
        Eigen::Vector3d pc_position = LaserCloudTransformed_XYZ - center_position_;
        // std::cout << center_position_  << std::endl;
        // std::cout << lidar2car_  << std::endl;

        if(pc_position(2) < -1 || pc_position(2) > 0) {
            non_count ++;
            continue;
        }

        // if(pc_position(0)  * pc_position(1)  + pc_position(0)  * pc_position(0) < 4) {
        //     continue;
        // }

        // std::cout << "x: " << pc_position(0)  << std::endl;
        // std::cout << "y: " << pc_position(1)  << std::endl;
        // std::cout << "z: " << pc_position(2)  << std::endl;
    ...
    /*****************************************************************************************************************************/
    local_range_min_ = center_position_ - sensor_range_; //sensor_range_ = 0, 0, 0
    ...
    globalOccVis();
    std::cout << "global map num: " << history_view_cloud_ptr_->points.size() << std::endl;
...
void MappingProcess::globalOccVis()
{
    // std::cout << "********globalOccVis_cb***********" << std::endl;
    ...
    //for vis 2d
    history_view_cloud_ptr_->points.clear();
    std::cout << "proc map num: " << history_view_cloud_ptr_->points.size() << std::endl;
    // int z = 0.2;
    std::cout << global_map_size_[0] << std::endl;
    std::cout << global_map_size_[1] << std::endl;
    ...
    //std::cout << x << std::endl;
        ...
        {
        //std::cout << y << std::endl;
        //std::cout << occupancy_buffer_2d_.at(y * global_map_size_(0) + x) << std::endl;
        //std::cout << "++++++++++++++" << std::endl;
            if (occupancy_buffer_2d_.at(y * global_map_size_(0) + x) > 0.5)
            {
                ...
                // std::cout << "++++++++++++++" << std::endl;
                // exit(0);
                //std::cout << "odom:" << std::endl << odom_msg->header << std::endl;
...
void MappingProcess::raycastProcess(const Eigen::Vector3d& t_wc, const pcl::PointCloud<pcl::PointXYZ>::Ptr laserCloudTransformed) //t_wc is the position of the lidar
{
    ...
    // std::cout << cache_voxel_.front(1) << std::endl;
...
{
    // std::cout << "************setCacheOccupancy************" << std::endl;
...
{
    // std::cout << "********localOccVis_cb***********" << std::endl;
