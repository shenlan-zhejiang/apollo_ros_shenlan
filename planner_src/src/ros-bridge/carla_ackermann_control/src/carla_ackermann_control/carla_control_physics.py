...
process[carla_ackermann_control_ego_vehicle-1]: started with pid [560033]
[INFO] [1651040207.311375, 474.156979]: Reconfigure Request:  speed (0.34, 4e-06, 4e-07), accel (0.34, 0.0, 0.05)
...
Traceback (most recent call last):
  ...
  File "/home/xulong/bk/VehicleBenchmark/src/ros-bridge/carla_ackermann_control/src/carla_ackermann_control/carla_ackermann_control_node.py", line 589, in loop
    self.vehicle_control_cycle()
  File "/home/xulong/bk/VehicleBenchmark/src/ros-bridge/carla_ackermann_control/src/carla_ackermann_control/carla_ackermann_control_node.py", line 357, in vehicle_control_cycle
    self.update_drive_vehicle_control_command()
  File "/home/xulong/bk/VehicleBenchmark/src/ros-bridge/carla_ackermann_control/src/carla_ackermann_control/carla_ackermann_control_node.py", line 506, in update_drive_vehicle_control_command
    self.info.status.throttle_lower_border = phys.get_vehicle_driving_impedance_acceleration(
  File "/home/xulong/bk/VehicleBenchmark/src/ros-bridge/carla_ackermann_control/src/carla_ackermann_control/carla_control_physics.py", line 91, in get_vehicle_driving_impedance_acceleration
    slope_force = get_slope_force(vehicle_info, vehicle_status)
  File "/home/xulong/bk/VehicleBenchmark/src/ros-bridge/carla_ackermann_control/src/carla_ackermann_control/carla_control_physics.py", line 186, in get_slope_force
    [vehicle_status.orientation.w, vehicle_status.orientation.x,
AttributeError: 'CarlaEgoVehicleStatus' object has no attribute 'orientation'
...
def get_slope_force(vehicle_info, vehicle_status):
    ...
    dummy_roll, pitch, dummy_yaw = quat2euler(
        [vehicle_status.pose.orientation.w, vehicle_status.pose.orientation.x,
         vehicle_status.pose.orientation.y, vehicle_status.pose.orientation.z])
