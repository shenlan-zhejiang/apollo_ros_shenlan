...
void *parse_data(void *para_)
{
  ...
  */
  ...
  // point_cloud2_.header.frame_id = "agent_0/mapping";
...
int main(int argc, char *argv[]) {
  ros::init(argc, argv, "mapping"); //节点名为study，随便取
  ros::NodeHandle n;
  struct para_t para;
  ...
  para.cap = 0;
  para.pub = n.advertise<sensor_msgs::PointCloud2>("/apollo/agent_0/mapping", 1000);
  para.relation_pub = n.advertise<std_msgs::String>("/apollo/agent_0/relation_mapping", 1000);
  para.counter_pub = 0;
  para.port = 8907;
  para.pfd = -1;
  para.index = -1;
