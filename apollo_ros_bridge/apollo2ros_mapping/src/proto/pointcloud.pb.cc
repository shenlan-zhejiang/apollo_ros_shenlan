...
static ::PROTOBUF_NAMESPACE_ID::Metadata file_level_metadata_pointcloud_2eproto[2];
...
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_pointcloud_2eproto_sccs[2] = {
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_pointcloud_2eproto = {
  &descriptor_table_pointcloud_2eproto_initialized, descriptor_table_protodef_pointcloud_2eproto, "pointcloud.proto", 344,
  &descriptor_table_pointcloud_2eproto_once, descriptor_table_pointcloud_2eproto_sccs, descriptor_table_pointcloud_2eproto_deps, 2, 1,
  schemas, file_default_instances, TableStruct_pointcloud_2eproto::offsets,
  file_level_metadata_pointcloud_2eproto, 2, file_level_enum_descriptors_pointcloud_2eproto, file_level_service_descriptors_pointcloud_2eproto,
};
...
::PROTOBUF_NAMESPACE_ID::uint8* PointXYZIT::InternalSerializeWithCachedSizesToArray(
    ...
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 18)) {
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParserUTF8Verify(_internal_mutable_frame_id(), ptr, ctx, "apollo.drivers.PointCloud.frame_id");
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
...
::PROTOBUF_NAMESPACE_ID::uint8* PointCloud::InternalSerializeWithCachedSizesToArray(
    ::PROTOBUF_NAMESPACE_ID::uint8* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  ...
  for (unsigned int i = 0,
    ...
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::
      InternalWriteMessageToArray(4, this->_internal_point(i), target, stream);
  }
