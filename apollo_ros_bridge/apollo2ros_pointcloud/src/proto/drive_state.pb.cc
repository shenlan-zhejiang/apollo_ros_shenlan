...
static void InitDefaultsscc_info_EngageAdvice_drive_5fstate_2eproto() {
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_EngageAdvice_drive_5fstate_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_EngageAdvice_drive_5fstate_2eproto}, {}};

static ::PROTOBUF_NAMESPACE_ID::Metadata file_level_metadata_drive_5fstate_2eproto[1];
static const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* file_level_enum_descriptors_drive_5fstate_2eproto[1];
static constexpr ::PROTOBUF_NAMESPACE_ID::ServiceDescriptor const** file_level_service_descriptors_drive_5fstate_2eproto = nullptr;

const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_drive_5fstate_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
...
const char descriptor_table_protodef_drive_5fstate_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "\020\004"
  ;
static const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable*const descriptor_table_drive_5fstate_2eproto_deps[1] = {
};
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_drive_5fstate_2eproto_sccs[1] = {
  &scc_info_EngageAdvice_drive_5fstate_2eproto.base,
};
static ::PROTOBUF_NAMESPACE_ID::internal::once_flag descriptor_table_drive_5fstate_2eproto_once;
static bool descriptor_table_drive_5fstate_2eproto_initialized = false;
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_drive_5fstate_2eproto = {
  &descriptor_table_drive_5fstate_2eproto_initialized, descriptor_table_protodef_drive_5fstate_2eproto, "drive_state.proto", 242,
  &descriptor_table_drive_5fstate_2eproto_once, descriptor_table_drive_5fstate_2eproto_sccs, descriptor_table_drive_5fstate_2eproto_deps, 1, 0,
  schemas, file_default_instances, TableStruct_drive_5fstate_2eproto::offsets,
  file_level_metadata_drive_5fstate_2eproto, 1, file_level_enum_descriptors_drive_5fstate_2eproto, file_level_service_descriptors_drive_5fstate_2eproto,
};

// Force running AddDescriptors() at dynamic initialization time.
static bool dynamic_init_dummy_drive_5fstate_2eproto = (  ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptors(&descriptor_table_drive_5fstate_2eproto), true);
namespace apollo {
namespace common {
const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* EngageAdvice_Advice_descriptor() {
  ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&descriptor_table_drive_5fstate_2eproto);
  return file_level_enum_descriptors_drive_5fstate_2eproto[0];
}
...
void EngageAdvice::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_EngageAdvice_drive_5fstate_2eproto.base);
  reason_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  advice_ = 1;
}
    ...
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 18)) {
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParserUTF8Verify(_internal_mutable_reason(), ptr, ctx, "apollo.common.EngageAdvice.reason");
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      default: {
