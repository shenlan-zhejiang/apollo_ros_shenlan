...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_header_2eproto = {
  &descriptor_table_header_2eproto_initialized, descriptor_table_protodef_header_2eproto, "header.proto", 279,
    ...
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 18)) {
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParserUTF8Verify(_internal_mutable_module_name(), ptr, ctx, "apollo.common.Header.module_name");
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      ...
      case 9:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 74)) {
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParserUTF8Verify(_internal_mutable_frame_id(), ptr, ctx, "apollo.common.Header.frame_id");
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      default: {
