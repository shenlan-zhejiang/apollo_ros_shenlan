...
void *parse_data(void *para_)
{
  ...
  */
  ...
  std::cout << "msg size: " << obj2.point_size() << std::endl;
  ...
  // point_cloud2_.header.frame_id = "agent_0/grid_map";
...
int main(int argc, char *argv[]) {
  ros::init(argc, argv, "gridmap"); //节点名为study，随便取
  ros::NodeHandle n;
  ...
  para.cap = 0;
  para.pub = n.advertise<sensor_msgs::PointCloud2>("/apollo/agent_0/grid_map", 1000);
  //para.relation_pub = n.advertise<std_msgs::String>("/apollo/agent_0/relation_grid_map", 1000);
  para.counter_pub = 0;
  para.port = 8906;
  para.pfd = -1;
  para.index = -1;
