...
extern PROTOBUF_INTERNAL_EXPORT_transform_2eproto ::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<2> scc_info_Transform_transform_2eproto;
extern PROTOBUF_INTERNAL_EXPORT_transform_2eproto ::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<2> scc_info_TransformStamped_transform_2eproto;
namespace apollo {
namespace transform {
...
static void InitDefaultsscc_info_Transform_transform_2eproto() {
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<2> scc_info_Transform_transform_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 2, 0, InitDefaultsscc_info_Transform_transform_2eproto}, {
      &scc_info_Point3D_geometry_2eproto.base,
      &scc_info_Quaternion_geometry_2eproto.base,}};

static void InitDefaultsscc_info_TransformStamped_transform_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<2> scc_info_TransformStamped_transform_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 2, 0, InitDefaultsscc_info_TransformStamped_transform_2eproto}, {
      &scc_info_Header_header_2eproto.base,
      &scc_info_Transform_transform_2eproto.base,}};

static void InitDefaultsscc_info_TransformStampeds_transform_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<2> scc_info_TransformStampeds_transform_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 2, 0, InitDefaultsscc_info_TransformStampeds_transform_2eproto}, {
      &scc_info_Header_header_2eproto.base,
      &scc_info_TransformStamped_transform_2eproto.base,}};

static ::PROTOBUF_NAMESPACE_ID::Metadata file_level_metadata_transform_2eproto[3];
...
const char descriptor_table_protodef_transform_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\017transform.proto\022\020apollo.transform\032\014hea"
  "der.proto\032\016geometry.proto\"e\n\tTransform\022+"
  "\n\013translation\030\001 \001(\0132\026.apollo.common.Poin"
  "t3D\022+\n\010rotation\030\002 \001(\0132\031.apollo.common.Qu"
  "aternion\"\201\001\n\020TransformStamped\022%\n\006header\030"
  "\001 \001(\0132\025.apollo.common.Header\022\026\n\016child_fr"
  "ame_id\030\002 \001(\t\022.\n\ttransform\030\003 \001(\0132\033.apollo"
  ".transform.Transform\"r\n\021TransformStamped"
  "s\022%\n\006header\030\001 \001(\0132\025.apollo.common.Header"
  "\0226\n\ntransforms\030\002 \003(\0132\".apollo.transform."
  "TransformStamped"
  ;
static const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable*const descriptor_table_transform_2eproto_deps[2] = {
  &::descriptor_table_geometry_2eproto,
  &::descriptor_table_header_2eproto,
};
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_transform_2eproto_sccs[3] = {
  &scc_info_Transform_transform_2eproto.base,
  &scc_info_TransformStamped_transform_2eproto.base,
  &scc_info_TransformStampeds_transform_2eproto.base,
};
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_transform_2eproto = {
  &descriptor_table_transform_2eproto_initialized, descriptor_table_protodef_transform_2eproto, "transform.proto", 416,
  &descriptor_table_transform_2eproto_once, descriptor_table_transform_2eproto_sccs, descriptor_table_transform_2eproto_deps, 3, 2,
  schemas, file_default_instances, TableStruct_transform_2eproto::offsets,
  file_level_metadata_transform_2eproto, 3, file_level_enum_descriptors_transform_2eproto, file_level_service_descriptors_transform_2eproto,
};

// Force running AddDescriptors() at dynamic initialization time.
static bool dynamic_init_dummy_transform_2eproto = (  ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptors(&descriptor_table_transform_2eproto), true);
namespace apollo {
namespace transform {
...
void Transform::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_Transform_transform_2eproto.base);
...
void TransformStamped::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_TransformStamped_transform_2eproto.base);
  child_frame_id_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
...
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  ...
  while (!ctx->Done(&ptr)) {
    ...
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 18)) {
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParserUTF8Verify(_internal_mutable_child_frame_id(), ptr, ctx, "apollo.transform.TransformStamped.child_frame_id");
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
...
void TransformStampeds::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_TransformStampeds_transform_2eproto.base);
  header_ = nullptr;
}
