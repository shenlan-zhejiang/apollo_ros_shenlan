...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_error_5fcode_2eproto = {
  &descriptor_table_error_5fcode_2eproto_initialized, descriptor_table_protodef_error_5fcode_2eproto, "error_code.proto", 1160,
    ...
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 18)) {
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParserUTF8Verify(_internal_mutable_msg(), ptr, ctx, "apollo.common.StatusPb.msg");
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      default: {
