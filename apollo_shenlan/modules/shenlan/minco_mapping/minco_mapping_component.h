...
#include "modules/shenlan/minco_mapping/plan_manage/replan_fsm.h"
#include "modules/shenlan/mpc/proto/Trajectory.pb.h"

namespace apollo{
namespace shenlan{

class MincoMappingShenlanComponent final : public cyber::Component<localization::LocalizationEstimate, drivers::PointCloud> 
{
    public:
...
CYBER_REGISTER_COMPONENT(MincoMappingShenlanComponent);
