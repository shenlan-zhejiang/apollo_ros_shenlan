...
class MpcShenlanComponent final : public cyber::Component<apollo::shenlan::mpc::EgoVehicleStatus>
{
    public:
    ...
    bool Init() override;
    bool Proc(const std::shared_ptr<apollo::shenlan::mpc::EgoVehicleStatus> &traj) override;
