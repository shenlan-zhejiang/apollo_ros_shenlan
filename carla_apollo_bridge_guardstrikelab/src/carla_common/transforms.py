...
def carla_odometry_to_cyber_odometry(carla_transform, carla_linear_velocity):
    cyber_pose = Pose()
    cyber_pose.position.CopyFrom(carla_location_to_cyber_point(carla_transform.location))
    cyber_pose.orientation.CopyFrom(carla_rotation_to_cyber_quaternion(carla_transform.rotation))
    cyber_pose.linear_velocity.CopyFrom(carla_location_to_cyber_point3d(carla_linear_velocity))
    return cyber_pose
